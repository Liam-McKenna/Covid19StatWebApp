    ...
    <ul class="navbar-nav">
        <li class="logo">
            <a href="index.php" class="navlink">
                <span class="link-text">C19 Data Tracker</span>
                <svg id="Capa_1" enable-background="new 0 0 484.559 484.559" height="512" viewBox="0 0 484.559 484.559" width="512" xmlns="http://www.w3.org/2000/svg">
                    <g>
                        <g id="XMLID_107_">
                            <g>
                        ...
                        <g id="XMLID_8_">
                            <g>
                                <circle cx="238.936" cy="243.983" fill="#f58a97" r="97.52" />
                            </g>
                        </g>
                        <path d="m171.14 243.983c0-48.807 35.852-89.238 82.658-96.395-4.846-.741-9.809-1.125-14.862-1.125-53.86 0-97.52 43.66-97.52 97.52s43.66 97.52 97.52 97.52c5.053 0 10.016-.384 14.862-1.125-46.805-7.158-82.658-47.589-82.658-96.395z" fill="#f07281" />
                        <g fill="#eb5569">
        ...
        <li class="nav-item">
            <a href="GlobalNews.php" class="navlink">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
